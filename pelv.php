...
class Pelv {
  ...
  public function handle_ajax_requests() {
    ...
    if ( isset( $_GET['get_log'] ) ) {
      return $this->ajax_json_log();
    }
    else if ( isset( $_GET['delete_log'] ) ) {
      return $this->ajax_delete();
    }
    else if ( isset( $_GET['filesize'] ) ) {
      return $this->ajax_filesize();
    }
    else {
      return $this->html();
    }
  ...
  public function ajax_json_log() {
    ...
    $file = $this->get_file();
    if ( ! $file ) {
      throw new RuntimeException( "File is empty or can't be opened." );
    }
  ...
  public function ajax_filesize() {
    $this->ajax_header();
    return json_encode( $this->get_size() );
  }
